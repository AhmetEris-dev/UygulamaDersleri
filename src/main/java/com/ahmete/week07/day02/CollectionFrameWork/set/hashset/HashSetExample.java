package com.ahmete.week07.day02.CollectionFrameWork.set.hashset;
...
public class HashSetExample {
	public static void main(String[] args) {
		...
		System.out.println("Ancak -30 ve -6 sayisini ekledigimizde, bu siralama algoritmasi bozulacaktir. Rastgelelik " +
				                   "isin icerisine dahil olacaktir...");
		oddNumberSet.add(-30);
		oddNumberSet.add(-6);
		System.out.println(oddNumberSet);
//        numberSet.add(41238);
...
//        numberSet.add(1234165);
		...
		System.out.println("evenNumbers.retainAll metodu ile kesisim kumesindeki elemanlari getirebiliriz. ( retainAll" +
				                   " set'in yapisini degistirir. Kesisim kumesi yeni set olur)");
